<?php
/**
 * AccountControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Account Module
 *
 * @category Test
 * @package Account
...
namespace OnePlaceTest\Account\Controller;

use OnePlace\Account\Controller\AccountController;
...
class AccountControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/account/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('account');
        $this->assertControllerName(AccountController::class); // as specified in router's controller name alias
        $this->assertControllerClass('AccountController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/account/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('account');
        $this->assertControllerName(AccountController::class); // as specified in router's controller name alias
        $this->assertControllerClass('AccountController');
