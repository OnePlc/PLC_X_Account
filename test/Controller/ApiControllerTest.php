...
use OnePlace\Account\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/account/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('account-api');
    }
}
